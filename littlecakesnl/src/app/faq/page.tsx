...
const FAQPage = () => {
  ...
  return (
    <>
      <Head>
        <title>FAQ - LittleCakesNL Custom Cakes Rotterdam & Vlaardingen</title>
        <meta name="description" content="Frequently asked questions about ordering custom cakes from LittleCakesNL. Learn about pickup locations, pricing, delivery, and more in Rotterdam and Vlaardingen." />
        <meta name="keywords" content="custom cake FAQ, cake ordering questions, Rotterdam cake pickup, Vlaardingen cake delivery, wedding cake questions, cake pricing" />
        <link rel="canonical" href="https://littlecakesnl.nl/faq" />
